<?php
/* Template Name: Terms & Client Agreement */
get_header(); ?>
...
<section class="section">
    <div class="container">
        <div class="privacy-content reveal">
            ...
            <h2>Who owns what</h2>
            <ul>
                <li><strong>Your stuff is yours.</strong> Your business name, logo, photos, words and customer data belong to you.</li>
                <li><strong>Our build is ours until paid for.</strong> The website design and code stay ours until your invoice is fully paid. Once paid, you own your finished site.</li>
                <li><strong>We can show our work.</strong> We may display your finished website in our portfolio and marketing as an example of what we do. Tell us in writing if you'd rather we didn't.</li>
            </ul>
            ...
            <ul>
                ...
                <li>We'll <strong>switch off bookings, forms, online orders and payments</strong> so no customer can try to buy from a closed business.</li>
                <li>We'll <strong>delete the customer personal data</strong> the site collected.</li>
