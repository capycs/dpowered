...
<section class="section testimonials-section">
    <div class="container">
        ...
        <div class="reviews-empty reveal">
            ...
            <p>We're just getting started — client reviews will appear here as our portfolio grows. In the meantime, get in touch and let's talk about your project.</p>
    ...
    <div class="container">
        <div class="review-submit-inner">
            ...
            <div class="review-success reveal">
                ...
                <h3>Thank you!</h3>
                <p>Your review has been received. We'll publish it shortly after a quick check — we really appreciate you taking the time.</p>
            </div>
            <?php else: ?>
